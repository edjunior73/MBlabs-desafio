...
import {
  SignUpEventMakerCommand,
  LoginEventMakerCommand,
  DeleteEventMakerCommand
} from '../cqrs/commands'
...
export class EventMakerService {
  ...
  deleteEventMaker(eventMakerId: string) {
    return this.commandBus.execute(new DeleteEventMakerCommand(eventMakerId))
  }
